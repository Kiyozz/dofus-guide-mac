...
<template>
  <div class="mt-6">
    <div class="flex">
      <button class="py-2 px-3 rounded-tl-lg" :class="tabs == 'tuto' ? 'bg-gray-900 shadow-2xl' : 'bg-gray-400'" @click="tabs = 'tuto'">Stuff Magem </button>
      <button class="py-2 px-3 flex gap-2" :class="tabs == 'huz' ? 'bg-gray-900 shadow-2xl' : 'bg-gray-400'" @click="tabs = 'huz'">
        <div><img src="https://www.huzounet.fr/_next/static/media/logo-huzounet.eeafcdfb.png" alt="" class="h-[25px]" /> </div>
        <div>Huz</div>
      </button>
      <button class="py-2 px-3 rounded-tr-lg" :class="tabs == 'dofusbook' ? 'bg-gray-900  shadow-2xl' : 'bg-gray-400'" @click="tabs = 'dofusbook'">Dofus Book </button>
    </div>
